...
const numberOfImagesChoices = [1, 2, 3, 4];
...
export function ProductDescription({
  ...
  okImageIndexes: number[];
  currentImageIndex: number;
  handleTestProduct: () => void;
}) {
  ...
  console.log('okImageIndexes', okImageIndexes);
  ...
  return (
    <div className="flex flex-col justify-between h-full">
      <div className="mb-6 flex flex-col border-b pb-6 dark:border-neutral-700">
        ...
        <h1 className="mb-3 text-xl font-medium">{product.brand}</h1>
      ...
      <div>
        ...
        <button
          ...
          disabled={!okImageIndexes.includes(currentImageIndex)}
          title={'Test product'}
          ...
          className={clsx(
            ...
            {
              'bg-blue-600': okImageIndexes.includes(currentImageIndex),
              'bg-blue-300 cursor-not-allowed opacity-70':
                !okImageIndexes.includes(currentImageIndex),
            }
          )}
        >
